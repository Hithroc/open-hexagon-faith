...
function onIncrement()
    ...
    messageImportantAdd("Increase: ".. increase .." Decrease:".. decrease, 175)
end
...
function onUpdate(mFrameTime)
    if (math.floor(time) < math.floor(time+mFrameTime)) then
        if (isKeyPressed(71) or isKeyPressed(0)) then
            r = r + (r > 0 and increase or decrease)
    ...
    setLevelValueFloat("rotation_speed", r/2000)
end
